...
public class Board {
    ...
    private Cards[][] board = new Cards[LENGTH][WIDTH];
    ...
    public Board() {
        List<Cards> cardList = Cards.generate25Cards();
    ...
    // randomized board?
    public void setBoard(Cards[][] board) {
        this.board = board;
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < WIDTH; i++) {
            for (int j = 0; j < LENGTH; j++) {
                str.append(this.board[i][j].getCodename() + "-");
                str.append(this.board[i][j].getTypeOfCard() + "\t\t");
            }
            str.append("\n");
        }
