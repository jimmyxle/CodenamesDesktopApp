...
public class SequentialOperativeStrategy implements Strategy {
    ...
    public Coordinates guessCard(Operative owner, ReadOnlyGameState state, String clue) {
        ...
        return ret==null? null : new Coordinates(nextRow, nextCol);
    }

    private Card getCardIfValid(Operative owner, ReadOnlyGameState state, int x, int y) {
