...
public class Operative extends Player {
	...
	public interface Strategy {
	    /**
	     * Requests a guess from this strategy, given the current game state. The guess must be stored
	     * in the given Promise.
	...
	Promise<Coordinates> guessCard(ReadOnlyGameState state, Clue clue) {
		return strategy.guessCard(this, state, clue)
            .then(coords->{
                if (coords==null) {
